...
public class CobblestoneGeneratorTier3BlockEntity extends AbstractCobblestoneGeneratorBlockEntity {
	public CobblestoneGeneratorTier3BlockEntity(BlockPos pos, BlockState state) {
		super(CobblestoneGeneratorsInit.COBBLE_GEN_TIER3_ENTITY, pos, state, "cobble_gen_tier3", (short)SimpleCobblestoneGenerator.TIERS[2]);
	}
}
